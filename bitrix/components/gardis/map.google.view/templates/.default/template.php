...
{
	echo '<img src="/bitrix/components/gardis/map.google.view/templates/.default/images/preview.png" border="0" />';
}
else
{
	$arTransParams = array(
	...
	$APPLICATION->IncludeComponent('gardis:map.google.system', '.default', $arTransParams, false, array('HIDE_ICONS' => 'Y'));
	?>
		</div>
	</div>
