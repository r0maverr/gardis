...
$arComponentParameters = array(
	"PARAMETERS" => array(
		...
		"REQUIRED_FIELDS" => Array(
			...
			"TYPE"=>"LIST", 
			"MULTIPLE"=>"Y", 
			"VALUES" => Array("NONE" => GetMessage("MFP_ALL_REQ"), "NAME" => GetMessage("MFP_NAME"),"COMPANY" => GetMessage("MFP_COMPANY"),"TOWN" => GetMessage("MFP_TOWN"),"PHONE" => GetMessage("MFP_PHONE"), "EMAIL" => "E-mail",  "MESSAGE" => GetMessage("MFP_MESSAGE")),
			"DEFAULT"=>"", 
			"COLS"=>25, 
			"PARENT" => "BASE",
		),
