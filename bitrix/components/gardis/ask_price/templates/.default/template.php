...
<?}?>
	...
	<?if (strlen($arResult["OK_MESSAGE"]) > 0):?>
		<div class="errors">
<?$APPLICATION->AddHeadString("<script>window.onload = function(){yaCounter24428276.reachGoal('ORDER_SUBMITED');}; var _gaq = _gaq || [];_gaq.push(['_trackEvent', 'форма', 'отправлена', 'узнать стоимость']);</script>")?>
