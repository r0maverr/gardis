...
$arComponentParameters = array(
	"PARAMETERS" => array(
		...
		"BUTTON_TITLE" => Array(
			"NAME" => GetMessage("MFP_BUTTON_TITLE"), 
			"TYPE" => "STRING",
			"DEFAULT" => "", 
			"PARENT" => "BASE",
		),
		"REQUIRED_FIELDS" => Array(
			...
			"TYPE"=>"LIST", 
			"MULTIPLE"=>"Y", 
			"VALUES" => Array("NONE" => GetMessage("MFP_ALL_REQ"), "NAME" => GetMessage("MFP_NAME"), "EMAIL" => "E-mail", "PHONE" => GetMessage("MFP_PHONE"), "COMPANY" => GetMessage("MFP_COMPANY"), "ADRESS" => GetMessage("MFP_ADRESS"), "MESSAGE" => GetMessage("MFP_MESSAGE")),
			"DEFAULT"=>"", 
			"COLS"=>25, 
			"PARENT" => "BASE",
		),
