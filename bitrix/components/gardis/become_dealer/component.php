	...
	if(check_bitrix_sessid())
	{
		...
		if(empty($arResult["ERROR_MESSAGE"]))
		{
			...
			$arFields = Array(
				...
				"TEXT" => $_POST["MESSAGE"],
				"SUBJECT_PREFIX" => (isset($arRef['clid'])) ? $arRef['clid'] : '—ео',
				"REFERER" => $referer
			);
			...
			//добавление за€вки в инфоблок
			
			if ($arParams["EVENT_MESSAGE_ID"][0] == 27) //за€вка на дилерство
				$reqType = 7;
			if ($arParams["EVENT_MESSAGE_ID"][0] == 30) //обращение к директору
				$reqType = 6;
			if ($arParams["EVENT_MESSAGE_ID"][0] == 29) //вопрос специалисту
				$reqType = 5;
