...
<div class="form_grid">
	...
	<?else:?>
		...
		<form action="<?=$APPLICATION->GetCurPage()?>" method="POST">
			<fieldset class="dealer-fieldset">
				<?=bitrix_sessid_post()?>
				...
				<input type="submit" class="grey_nice_button on_right dir" name="submit" value="<?=$arParams["BUTTON_TITLE"];?>" onclick="yaCounter24428276.reachGoal('<?=(isset($_GET['yclid']) || isset($_COOKIE['gardies-yclid-phone']))?'DIRECT':'ASK_A_QUESTION_SUBMIT'?>'); return true;">
			</fieldset>
		</form>
	<?endif;?>
</div>