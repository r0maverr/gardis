...
<?if($arParams["DISPLAY_PICTURE"]!="N" && is_array($arResult["DETAIL_PICTURE"])):?>
	<a href="<?=$arResult["DETAIL_PICTURE"]["SRC"]?>" rel="group" title="<?=$arResult["NAME"]?>" class="fancybox">
		<img src="<?=$arResult["PREVIEW_PICTURE"]["SRC"]?>" width="<?=$arResult["PREVIEW_PICTURE"]["WIDTH"]?>" height="<?=$arResult["PREVIEW_PICTURE"]["HEIGHT"]?>" alt="<?=$arResult["NAME"]?>"  title="<?=$arResult["NAME"]?>" class="grey_border"/>
	</a>
<?endif?>
...
?>
	<span class="prevall"><a href="<?=$arParams["BACK_HREF"]?>" ><?//=$arParams["BACK_TITLE"]?> Возврат к списку</a></span>
</div>
