...
?>
  ...
  <div class="form__html-text"> 
    ...
    <p>Чтобы мы приготовили для Вас коммерческое предложение на ограждение территории и документы для проведения тендера, 
	заполните форму ниже и приложите техническое задание при необходимости.</p>
   </div>
