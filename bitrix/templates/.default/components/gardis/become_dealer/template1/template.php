	...
	<?else:?>
		...
		<form action="<?=$APPLICATION->GetCurPage()?>" method="POST">
			<fieldset>
				...
				<input type="submit" class="grey_nice_button on_right" name="submit" value="<?=$arParams["BUTTON_TITLE"];?>" onclick="yaCounter24428276.reachGoal('ASK_A_QUESTION_SUBMIT'); return true;">
			</fieldset>
		</form>
	<?endif;?>
</div>